document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveToLocalStorage() {
      try {
        ...
        alert('Failed to save habits. Please try again later.'); // Notify user of error
      }
    }
    ...
    function addHabit() {
      ...
      habits.push({ id: Date.now(), name: habitName, completed: false, datesCompleted: [] });
      saveToLocalStorage();
      habitInput.value = '';
      habitInput.focus();
      displayHabits();
      ...
      // Scroll to the newly added habit
      habitList.lastElementChild.scrollIntoView({ behavior: 'smooth' });
    }
